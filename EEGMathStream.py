...
# Попробуем импортировать matplotlib с обработкой ошибок
try:
    import matplotlib
    ...
    st.error(f"Ошибка импорта matplotlib: {e}")
    MATPLOTLIB_AVAILABLE = False

# Попробуем импортировать остальные научные библиотеки
try:
    import pyedflib
...
if not all([MATPLOTLIB_AVAILABLE, PYEDFLIB_AVAILABLE, PYWAVELETS_AVAILABLE, SCIPY_AVAILABLE]):
    st.error("""
    ⚠️ Не все необходимые библиотеки установлены. Пожалуйста, установите зависимости:
...
def main():
    ...
    st.title("🧠 Поиск быстроволновой ритмической активности")
    st.markdown("""
